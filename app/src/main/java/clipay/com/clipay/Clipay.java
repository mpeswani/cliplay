 ...
 */
public class Clipay extends MultiDexApplication {
     ...
     */
    public DataSource.Factory buildDataSourceFactory(TransferListener<? super DataSource>
                                                             listener) {
    ...
    private static CacheDataSourceFactory buildReadOnlyCacheDataSource(
        ...
        return new CacheDataSourceFactory(
                ...
                new CacheDataSinkFactory(cache, 2048 * 1000 * 100),
