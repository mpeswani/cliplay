package clipay.com.clipay.license
...
fun showLicesnse(context: Context) {
    val result = Single.fromCallable {
        ...
        return@fromCallable Gson().fromJson(jsonArray.toString(), Array<clipay.com.clipay.license.License>::class.java).toList()
    }.subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
            .subscribeWith(object : DisposableSingleObserver<List<clipay.com.clipay.license.License>>() {
                override fun onSuccess(list: List<clipay.com.clipay.license.License>) {
