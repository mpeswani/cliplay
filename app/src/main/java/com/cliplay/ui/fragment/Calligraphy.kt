...
import com.clipay.texteditor.text.parser.Parser
import com.clipay.texteditor.text.renderer.MarkdownBuilder
import com.cliplay.R
import com.cliplay.ui.adapter.ColorPickerAdapter
...
//                        color_picker_list.setBackgroundResource(R.drawable.recycler_view_side_background)
        ...
        val bulletPointColor = ContextCompat.getColor(activity!!, R.color.colorAccent)
        val codeBackgroundColor = ContextCompat.getColor(activity!!, R.color.white)
        val codeBlockTypeface = ResourcesCompat.getFont(activity!!, R.font.inconsolata)


        val markdownBuilder = MarkdownBuilder(bulletPointColor, codeBackgroundColor,
...
//                edit_query.removeTextChangedListener(this)
//                markdownBuilder.markdownToSpans(p0.toString())
//                edit_query.setText(p0)
