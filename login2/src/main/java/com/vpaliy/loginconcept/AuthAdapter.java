...
public class AuthAdapter extends FragmentStatePagerAdapter
    ...
    private void shiftSharedElements(float pageOffsetX, boolean forward) {
        ...
        for (View view : sharedElements) {
            ...
            ObjectAnimator shift = ObjectAnimator.ofFloat(view, View.TRANSLATION_X, 0,
                    translationX);
            shiftAnimator.playTogether(shift);
        }
        int color = ContextCompat.getColor(context, forward ? R.color.color_logo_sign_up : R
        ...
        ObjectAnimator scrollAnimator = ObjectAnimator.ofInt(authBackground, "scrollX", forward ?
                offset : -offset);
