...
object KnifeParser {
    fun fromHtml(source: String): Spanned {
        return Html.fromHtml(source, null, KnifeTagHandler())
    }
    ...
    private fun withinHtml(out: StringBuilder, text: Spanned) {
        ...
        while (i < text.length) {
            ...
            val styles = text.getSpans<ParagraphStyle>(i, next, ParagraphStyle::class.java)
            if (styles.size == 2) {
    ...
    private fun withinBullet(out: StringBuilder, text: Spanned, start: Int, end: Int) {
        ...
        while (i < end) {
            ...
            val spans = text.getSpans<BulletSpan>(i, next, BulletSpan::class.java)
            for (span in spans) {
                out.append("<li>")
            }
    ...
    private fun withinParagraph(out: StringBuilder, text: Spanned, start: Int, end: Int, nl: Int) {
        ...
        run {
            ...
            while (i < end) {
                ...
                val spans = text.getSpans<CharacterStyle>(i, next, CharacterStyle::class.java)
